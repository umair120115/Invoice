...
const UpdatedMobileNotificationApp = () => {
  ...
  const filterOptions = [
    ...
    {
      id: 'order-summary-current-day',
      label: 'Today Order Summary',
      description: 'Users with items in cart and have order summary but order not placed today!',
      icon: Users,
      apiEndpoint: '/api/admincontrol/user-order-summary/?is_today=true',
      color: '#059669'
    },
    {
      id: 'shopping-session-current-day',
      label: 'Today Items added in cart!',
      description: 'Users who have added items to their cart today!',
      icon: Users,
